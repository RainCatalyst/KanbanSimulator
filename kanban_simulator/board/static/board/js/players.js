...
function createCharacterTemplate(role){
    ...
    switch(role){
        case 0:
            //template = '<li class="anl_player players" id="anl_player0"></li>';
            ...
            break;
        case 1:
            //template = '<li class="anl_player players" id="anl_player1"></li>';
            ...
            break;
        case 2:
            //template = '<li class="dev_player players" id="dev_player2"></li>';
            ...
            break;
        case 3:
            //template = '<li class="dev_player players" id="dev_player3"></li>';
            ...
            break;
        case 4:
            //template = '<li class="dev_player players" id="dev_player4"></li>';
            ...
            break;
        case 5:
            //template = '<li class="tst_player players" id="tst_player5"></li>';
            ...
            break;
        case 6:
            //template = '<li class="tst_player players" id="tst_player6"></li>';
